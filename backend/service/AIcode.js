...
const generateCodeAnalysisPrompt= (code)=>{
  ...
  task is to analysis the code and provide the feeback and also provide the correct code and if no issue is found then the give the optimized code for the problem 
